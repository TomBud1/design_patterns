...
import simpleBuilder.BridgeBuilder;
import simpleBuilder.BuildingCompany;
import simpleBuilder.Construction;
import simpleBuilder.ConstructionBuilder;
import simpleBuilder.MonumentBuilder;
import simpleBuilder.HouseBuilder;

public class ConstructionBuilderTest {

    BuildingCompany buildingCompany;

    @Before
    public void prepare_construction_park() {
