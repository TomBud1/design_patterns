...
public class SerializationSingletonTest {
    ...
    @Test
    public void check_if_serialized_singleton_object_has_the_same_hashcode() throws IOException, ClassNotFoundException {

        SerializationSingleton singleton = SerializationSingleton.getInstance();

        singleton.name = "first singleton";
        singleton.age = 1;
        ...
        singleton.name = "second singleton";
        singleton.age = 2;
